/**handles:et-core-common,smush-lazy-load**/
!(function (t) {
  t(document).ready(function () {
    var e = navigator.userAgent,
      a,
      i = e.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))/i) || [],
      o = "",
      n = "";
    switch (
      (/trident/i.test(i[0])
        ? (o = "ie")
        : "Chrome" === i[0] &&
          null !== (a = e.match(/\b(OPR|Edge)/)) &&
          (o = a[0].replace("OPR", "opera")),
      (o = (o =
        "" === o
    ...
    e.match(/iPhone/) && (n += " iphone"), t("body").addClass(n);
  });
})(jQuery);
!(function () {
  var e = {
          ...
          var n = (function (e, t, n) {
            ...
            var r = t.documentElement,
              ...
              w =
                ...
                (Ce = function () {
                  var e = be;
                  for (be = ze.length ? he : ze, ge = !0, pe = !1; e.length; )
                    e.shift()();
                  ge = !1;
                }),
                (Ae = function (e, n) {
                  ge && !n
                    ...
                    : (be.push(e), pe || ((pe = !0), (t.hidden ? d : u)(Ce)));
                }),
                (Ae._lsFlush = Ce),
                Ae),
              M = function (e, t) {
              ...
              L =
                  ...
                  if ((D = i.loadMode) && Z < 8 && (e = p.length)) {
                    for (n = 0, ee++; n < e; n++)
                      if (p[n] && !p[n]._lazyRace)
                        if (
                          !V ||
                          (a.prematureUnveil && a.prematureUnveil(p[n]))
                        )
                          fe(p[n]);
                        else if (
                          (((f = p[n][l]("data-expand")) && (d = 1 * f)) ||
                            (d = Y),
                          v ||
                            ((v =
                              !i.expand || i.expand < 1
                ...
                (ue = M(function (e, t, n, a, r) {
                  ...
                  (f = C(e, "lazybeforeunveil", t)).defaultPrevented ||
                    (a &&
                      (n ? z(e, i.autosizesClass) : e.setAttribute("sizes", a)),
                    (s = e[l](i.srcsetAttr)),
                    (o = e[l](i.srcAttr)),
                    ...
                    (f = { target: e }),
                    z(e, i.loadingClass),
                    v && (clearTimeout(k), (k = d(te, 2500)), b(e, le, !0)),
              ...
              W =
                ...
                (F = function (e, t, n) {
                  ...
                  i &&
                    ((n = _(e, i, n)),
                    (a = C(e, "lazybeforesizes", { width: n, dataAttr: !!t }))
                      .defaultPrevented ||
                      ((n = a.detail.width) &&
                        n !== e._lazysizesWidth &&
                        T(e, i, a, n)));
